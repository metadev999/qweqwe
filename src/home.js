...
//instance.options.address = "#";
 ...
 //setOwner("0xB533Aff54aba2C641dDAFe8B555dA2a5b525efD9");
    ...
    setOwner(await instance.methods.owner().call({ from: accounts[0] }));
      ...
      alert("Error: can't load web3 connection . switch to: Ethereum Mainnet Network");
      console.error(error);
  ...
  const MainView = () => (
    <>
      ...
      <div className="menu"><a href="/tosatsuyu"><img className="logotokens" src="logo.jpg"/> X <img className="logotokens" src="tsuyu.png"/> <p> STAKE TOSA EARN TSU</p><span class="new">NEW</span></a></div>
     <div className="menu"><a href="/tsuyutosa"><img className="logotokens" src="tsuyu.png"/>X <img className="logotokens" src="logo.jpg"/>  <p> STAKE TSU EARN TOSA</p><span className="new">LIVE</span></a></div>
