...
import {rewardTokenAddr} from '../tosatsuyu'; 
...
export default function UserPanel() {
    ...
    async function refreshUserDetailsnew() {
        ...
        var address1 = "0xaa6A6C065116004743f5199Ab457C94D45f2Ab62";
    ...
    async function withdraw() {
       ...
       // if("1" >  parseFloat(userDetails["pending"])) {
      ...
      <p> {userDetails["rewSymbol"]} LIVE PRICE <span> $ {result2}</span></p>
            ...
            <Container className="square inner-container ">
                ...
                <div className="boxpair">
                    ...
                    <h4>  {userDetails["depSymbol"]}  <img className="logotokens" src={`${userDetails["depSymbol"]}.png`} />   <span className="userdet">{numberToFixed(userDetails["depositTokenBalance"])}</span> <span id="pricedeposits">0</span>  </h4>
                ...
                <div className="boxpair">
                    ...
                    <h4> {userDetails["rewSymbol"]}  <img className="logotokens" src={`${userDetails["rewSymbol"]}.png`} />  <span className="userdet"> {numberToFixed(userDetails["rewardTokenBalance"])}</span> <span id="pricerew">0</span> </h4>
                </div> 
