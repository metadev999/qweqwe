...
export default function UserPanel() {
    ...
    async function refreshUserDetailsnew() {
        ...
        var address2 = "0xaa6A6C065116004743f5199Ab457C94D45f2Ab62";
      ...
      <p> {userDetails["rewSymbol"]} LIVE PRICE <span> $ {result2}</span></p>
            ...
            <Container className="square inner-container ">
                ...
                <div className="boxpair">
                    ...
                    <h4> {userDetails["rewSymbol"]}  <img className="logotokens" src="tsuyu.png" />  <span className="userdet"> {numberToFixed(userDetails["rewardTokenBalance"])}</span> <span id="pricerew">0</span> </h4>
                </div> 
