...
import UserPanel from "./tosatsuyucomponents/UserPanel";
...
function App() {
  ...
  //instance.options.address = "0xAcE11d70D31024Bd71F8867F6d97579Fb2692863";
      ...
      instance.options.address = "0x4DDaF0F7e69aBb663a6A247c78942Df985D443c6";
  ...
  const MainView = () => (
    <>
      ...
      <div className="menu"><a href="/tosatsuyu"><img className="logotokens" src="logo.jpg"/> X <img className="logotokens" src="tsuyu.png"/> <p> STAKE TOSA EARN TSU</p><span class="new">LIVE</span></a></div>
     <div className="menu"><a href="/tsuyutosa"><img className="logotokens" src="tsuyu.png"/>X <img className="logotokens" src="logo.jpg"/>  <p> STAKE TSU EARN TOSA</p><span class="new">LIVE</span></a></div>
