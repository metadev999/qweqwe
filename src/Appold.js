...
function App() {
  ...
  //instance.options.address = "0x30516a582248bEd857b5B9a87b7B23b1a92554d6";
 ...
 setOwner("0xB533Aff54aba2C641dDAFe8B555dA2a5b525efD9");
  ...
  const MainView = () => (
    <>
      ...
      <div className="menu"><a href="https://staketosaaaaa.vercel.app/"><img className="logotokens" src="logo.jpg"/> X <img className="logotokens" src="logo.jpg"/> <p> STAKE TOSA EARN TOSA </p></a></div>
  <div className="menu"><a href="https://okagi.vercel.app/"><img className="logotokens" src="logo.jpg"/> X <img className="logotokens" src="okag.png"/> <p> STAKE TOSA EARN OKAGE</p></a></div>
     <div className="menu"><a href="https://okagetosa.vercel.app/"><img className="logotokens" src="okag.png"/>X <img className="logotokens" src="logo.jpg"/>  <p> STAKE OKAGE EARN TOSA</p></a></div>
